...
/*
   <img src="https://avatars.githubusercontent.com/u/88151620?v=4">
*/
   ...
   return (
      <>
         ...
         <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', margin:'20px' }}>
            <img src="https://avatars.githubusercontent.com/u/88151620?v=4" alt="@codexpression-nj" size="48" height="48" width="48" data-view-component="true" class="avatar circle mr-3" />
            <h2 style={{margin:'5px'}}>
               Matlale Paulos Tebeila
            </h2>
